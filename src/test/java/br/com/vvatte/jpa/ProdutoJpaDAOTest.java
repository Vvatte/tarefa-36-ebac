...
import main.java.br.com.vvatte.dao.jpa.IProdutoJpaDAO;
import main.java.br.com.vvatte.dao.jpa.ProdutoJpaDAO;
...
public class ProdutoJpaDAOTest {
	...
	public void alterarCliente() throws TipoChaveNaoEncontradaException, DAOException, MaisDeUmRegistroException, TableException {
		...
		produto.setNome("Vini");
		produtoDao.alterar(produto);
		ProdutoJpa produtoBD = (ProdutoJpa) this.produtoDao.consultar(produto.getId());
		assertNotNull(produtoBD);
		Assert.assertEquals("Vini", produtoBD.getNome());
	}
